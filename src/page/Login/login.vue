        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            ...
            <li style="text-align: right" class="pr">
              ...
              <a href="javascript:;" class="register" @click="toRegister">注册 h-seckill 账号</a>
  ...
  export default {
    ...
    methods: {
      ...
      login () {
        ...
        // 获取登陆前地址，待登陆成功后跳转回去
        let fromPath = this.$route.params.fromPath
  ...
  * {
  ...
  .v2 .dialog {
    ...
    .title {
      ...
      background: url(/static/images/150_110S.png) no-repeat top center;
      height: 92px;
      margin: 23px 0 50px;
      padding: 75px 0 0;
      box-shadow: none;
